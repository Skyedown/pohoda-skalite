...
export const AdminQuickActions: React.FC<AdminQuickActionsProps> = ({
  ...
  return (
    <div className="admin-panel__quick-actions">
      ...
      <Link
        to="/admin/settings"
        className="admin-panel__action-btn admin-panel__action-btn--settings"
      >
        <svg
          width="24"
          height="24"
      ...
      <Link
        to="/admin/products"
        className="admin-panel__action-btn admin-panel__action-btn--products"
      >
        <svg
          width="24"
          height="24"
      ...
      <Link
        to="/admin/users"
        className="admin-panel__action-btn admin-panel__action-btn--users"
      >
        <svg
          width="24"
          height="24"
