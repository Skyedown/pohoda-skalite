...
const OrderItemRow: React.FC<OrderItemRowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="order-item-row__left">
        ...
        <div className="order-item-row__details">
          ...
          {item.removedIngredients && item.removedIngredients.length > 0 && (
            <p className="order-item-row__removed-ingredients">
              <span className="order-item-row__removed-label">Bez:</span>{' '}
      ...
      {/* Center: Quantity Controls + Prílohy Button + Upravit Button */}
      <div className="order-item-row__center">
        ...
        {item.product.ingredients && item.product.ingredients.length > 0 && onEditIngredients && (
          <button
            type="button"
            className="order-item-row__ingredients-btn"
            onClick={() => onEditIngredients(itemIndex)}
          >
            <svg
              width="14"
              height="14"
