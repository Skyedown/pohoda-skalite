      ...
      <div className="container">
        <div className="delivery-info-section__content">
          ...
          <div className="delivery-info-section__grid">
            <div className="delivery-info-card">
              ...
              <p className="delivery-info-card__fee">
                Donáška:{' '}
                <strong className="delivery-info-card__free">ZADARMO</strong>
              </p>
            </div>
          ...
          <div className="delivery-info-section__note">
            ...
            <p>
              Pri objednávke nezabudnite uviesť presné mesto a adresu doručenia.
              Objednávky pod minimálnu sumu nie je možné odoslať.
            </p>
          </div>
        </div>
      </div>
